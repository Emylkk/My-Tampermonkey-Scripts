...
(function() {
    ...
    $(window.parent).on('mousedown' ,function (e) {
        ...
        if(e.which==5){
            if (document.referrer != "https://betteranime.net/" ){
    ...
    jwplayer().on('time', function(event){
        ...
        if (document.referrer.includes("bleach") ){
            if((event.duration-event.position)< 130 && testedetempo == true){
